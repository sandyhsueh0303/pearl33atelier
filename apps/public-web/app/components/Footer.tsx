        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <path
              ...
              opacity="0.78"
            />
            <circle cx="7.1" cy="9.95" r="0.95" fill="#2c2c2c" />
            <circle cx="11.2" cy="9.95" r="0.95" fill="#2c2c2c" />
            <circle cx="14.3" cy="14.1" r="0.85" fill="#2c2c2c" />
            <circle cx="17.7" cy="14.1" r="0.85" fill="#2c2c2c" />
          </svg>
        </a>
        <a
          href={lineUrl}
